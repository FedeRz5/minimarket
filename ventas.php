...
<body>
    ...
    <div class="sidebar" id="sidebar">
        <div class="p-3">
            <ul class="nav flex-column">
                ...
                <li class="nav-item"><a class="nav-link" href="productos.php"><i
                            class="fas fa-box me-2"></i>Productos</a></li>
                <li class="nav-item"><a class="nav-link active" href="ventas.php"><i
                            class="fas fa-shopping-cart me-2"></i>Ventas</a></li>
                <li class="nav-item"><a class="nav-link" href="cajas.php"><i
                            class="fas fa-cash-register me-2"></i>Cajas</a></li>
    ...
    <div class="main-content">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <!-- Contenedor para el detalle -->
                <div id="detalleVentaContainer" style="margin-top: 20px;"></div>
            </div>
        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <input type="number" class="form-control" name="cantidades[]"
                                                placeholder="Cantidad" min="1" onchange="calculateTotal()">
                                        </div>
                                        <div class="col-md-2">
    ...
    <script>
        ...
        function viewSale(idVenta) {
            const container = document.getElementById('detalleVentaContainer');
            container.innerHTML = '<div class="text-center">Cargando detalle...</div>';
            ...
            fetch('detalle_venta.php?id=' + idVenta)
                ...
                <div class="card">
                    <div class="card-header bg-info text-white">
                        <h5>Detalle de la Venta #${idVenta}</h5>
                    </div>
            ...
            `;
                ...
                .catch(error => {
                    container.innerHTML = '<div class="alert alert-danger">Error al cargar el detalle.</div>';
                    console.error(error);
                });
        }
    </script>
